...
export function Skeleton({ palette, ...props }: BadgeIconProps) {
  const [l, m, d, d2] = getColors(palette, [
    "#ffffff",
    "#d1cdd5",
    "#847d8b",
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={d}
      />
      <path d="M7 8H5v2h2V8Z" fill={d2} />
      <path d="M12 7H9v3h3V7Z" fill={d} />
      <path d="M12 8h-2v2h2V8Z" fill={d2} />
      <path
        d="M12 12.01h1v-1h-1v1ZM11 14.01h1v-1h-1v1ZM13 11.01h1v-1h-1v1Z"
        fill={d}
      />
      <path d="M1 4H0v6h1V4Z" fill="#000" />
      <path d="M2 4H1v6h1V4Z" fill={l} />
      <path
        ...
        fill="#000"
      />
      <path d="M14 10.01h1v-6h-1v6Z" fill={d} />
      ...
      <path d="M5 14v1h6v-1H5Z" fill={d} />
      <path d="M7 13H6v2h1v-2ZM10 13H9v2h1v-2Z" fill={d2} />
    </svg>
  );
}
